...
//
//            else {
//                //请注意，这个接口可以在主线程执行网络，这可能导致主线程卡死。其中利弊需要开发者自己来判定
//                Object o = new AsyncResult.AsyncResultBuilder() {
//
//                    @Override
...
//                                asyncResult.notifyDataArrival(e);
//                            }
//
//                            @Override
...
//                                    }
//                                }
//                                asyncResult.notifyDataArrival(retStr);
//                                response.close();
//                            }
//                        });
//                    }
//                }.build().waitCallback(getClient().connectTimeoutMillis()
//                        + getClient().writeTimeoutMillis()
//                        + getClient().readTimeoutMillis()
//                        + 20
//                ).finalResult();
//                if (o == null) {
//                    return null;
...
//            }
            ...
            Log.e(SocksServerManager.TAG, "http client access error", e);
            return null;
        } finally {
            if (response != null) {
                response.close();
